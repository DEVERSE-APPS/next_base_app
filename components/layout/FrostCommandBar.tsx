    ...
    <div className="fixed bottom-8 left-1/2 z-50 w-full max-w-xl -translate-x-1/2 px-4">
      ...
      >
        ...
        <div className="flex items-center gap-2">
          <kbd className="hidden h-6 items-center gap-1 rounded border border-slate-200 bg-white/50 px-1.5 font-mono text-[10px] font-medium text-slate-500 sm:flex">
            <span className="text-xs">⌘</span>K
          </kbd>
          
          <div className="h-6 w-px bg-slate-200" />
          
          <button className="flex h-8 w-8 items-center justify-center rounded-lg text-slate-500 transition-colors hover:bg-slate-100 hover:text-blue-600">
            <Plus size={18} />
          </button>
          <button className="flex h-8 w-8 items-center justify-center rounded-lg text-slate-500 transition-colors hover:bg-slate-100 hover:text-blue-600">
            <Settings size={18} />
        ...
        {/* Subtle glow effect */}
        <div className="absolute -inset-px -z-10 rounded-2xl bg-gradient-to-r from-blue-500/0 via-blue-500/10 to-indigo-500/0 opacity-0 transition-opacity group-hover:opacity-100" />
      </motion.div>
    </div>
  );
}
