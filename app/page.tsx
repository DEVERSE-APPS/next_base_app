...
export default function DashboardPage() {
  return (
    <div data-dev-id="0kzx20b" className="flex flex-col gap-8">
      <header data-dev-id="0kzx2r1" className="flex items-center justify-between">
        <div data-dev-id="0kzx3hr">
          <h1
            data-dev-id="0kzx48h"
            className="font-heading text-3xl font-semibold tracking-tight text-slate-900">
            Dashboard
          </h1>
          <p data-dev-id="0kzx6gl" className="text-slate-600">
        ...
        <Button
          ...
          <Plus data-dev-id="0kzxpqp" className="mr-2 h-4 w-4" />
          Create Board
        </Button>
      </header>
      <div
        ...
        <motion.div
          ...
          <div
            ...
            <Plus data-dev-id="0bolqoz" size={24} />
          </div>
          <span
            data-dev-id="0bon0o2"
            className="mt-3 text-sm font-medium text-slate-500 group-hover:text-blue-600">
            Create new board
          </span>
        </motion.div>
      </div>
